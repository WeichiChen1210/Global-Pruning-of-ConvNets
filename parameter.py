...
def build_parser():
    ...
    parser.add_argument('--retrain-lr',type=float,
                    help='learning rate for retraining pruned network', default=1e-2)
    ...
    parser.add_argument('--network', type=str,
                    help='the type of network', default=None)

    parser.add_argument('--prune-ratio', type=float,
                    help='ratios of channel to prune resnet stages', default=0)

    parser.add_argument('--skip-layers', nargs='+', type=int,
                    help='layers to be skipped when pruning', default=[])
    ...
    parser.add_argument('--epoch', type=int,
                    help='number of epoch for training network', default=160)
    ...
    parser.add_argument('--lr-milestone', type=list,
                    ...
                    # help='list of epoch for adjust learning rate', default=[30, 40])
    ...
    parser.add_argument('--weight-decay', type=float,
                    help='factor for weight decay in optimizer', default=1e-3)
